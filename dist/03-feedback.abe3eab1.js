...
const getValuesFeedbackForm = function () {
  if (_localStorage.default.load('feedback-form-state')) {
    valuesFeedbackForm = _localStorage.default.load('feedback-form-state');
...
const onFeedbackFormInput = function (event) {
  ...
  _localStorage.default.save('feedback-form-state', valuesFeedbackForm);
};

const onSubmitFeedbackForm = event => {
  event.preventDefault();

  _localStorage.default.remove('feedback-form-state');

  event.target.reset();
  console.log(valuesFeedbackForm);
};

feedbackFormEl.addEventListener('input', (0, _lodash.default)(onFeedbackFormInput, 500));
feedbackFormEl.addEventListener('submit', onSubmitFeedbackForm);
},{"../sass/main.scss":"sass/main.scss","lodash.throttle":"../node_modules/lodash.throttle/index.js","./localStorage":"js/localStorage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
